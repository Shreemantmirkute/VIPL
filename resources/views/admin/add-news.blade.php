            ...
            <div class="breadcrumbbar">
              <div class="row align-items-center">
                  ...
                  <div class="col-md-4 col-lg-4">
                      <div class="widgetbar">
                        <button id="hide-btn" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add News</button>
                      </div>                        
                  </div>
              </div>          
            </div>
                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body">                                
                            <form method="POST" action="{{ url('admin/add-news') }}" enctype="multipart/form-data">
                              ...
                              <div class="form-row">
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" name="title"  autocomplete="name" autofocus placeholder="News Title">
                                </div>
                                <div class="col-sm-6">
                                  <input type="text" class="form-control" name="link"  autocomplete="link" autofocus placeholder="Link">
                                </div>
                              </div>
                              <br>
                              <div class="form-row">
                                <div class="col-sm-12">
                                   <textarea type="text" class="form-control" name="description" placeholder="Description" rows="4" maxlength="180"></textarea>              
                                </div>
                              </div>
                              <br>
                              <div class="form-row">
              ...
              <div class="card-header">
                ...
                <div class="" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    <form class="form-inline my-2 my-lg-0" method="POST" action="{{ url('admin/filter-news') }}">
                      @csrf
                ...
                <br>
                 ...
                 <div class="table-responsive">
                  ...
                  <thead>
                    ...
                    <th data-orderable="false">PDF</th>
