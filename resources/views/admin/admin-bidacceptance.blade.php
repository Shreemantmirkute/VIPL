      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Bid/Acceptance</a>
          </div>
                ...
                <div class="card-body ">
                  <ul class="nav nav-pills nav-pills-warning" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active show" data-toggle="tab" href="#link1" role="tablist">
                        Bid/Acceptance(Sellers)
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" data-toggle="tab" href="#link2" role="tablist">
                        Bid/Acceptance(Buyers)
                      </a>
                    </li>
                  </ul>
                  <div class="tab-content tab-space">
                    <div class="tab-pane active show" id="link1">
                      <div class="card">
                        <div class="card-header card-header-primary">
                          <h4 class="card-title">Bid/Acceptance(Sellers)<span class="badge badge-light float-right">{{$productforbuyersss}}</span></h4>
                            ...
                            <div class="row">
                              <table class="table table-sm">
                                ...
                                @foreach($productforbuyers as $productforbuyer)
                                  <tr>
                                    <td>{{ \Illuminate\Support\Str::limit($productforbuyer->product, $limit = 10, $end = '...') }}</td>
                                    <td>{{ $productforbuyer->price }}</td>
                                    <td>{{ $productforbuyer->quantity }}</td>
                                    <td>{{ $productforbuyer->status }}</td>
                                    <td>
                                      <a type="button" rel="tooltip" title="View" class="btn btn-primary btn-link btn-sm" data-toggle="modal" data-target="#view{{ $productforbuyer->price }}"><i class="material-icons">visibility</i>
                                      </a>
                                      <div class="modal fade" id="view{{ $productforbuyer->price }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          ...
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                              <table class="table table-sm table-bordered">
                                                <tr>
                                                  <th>Product Id</th>
                                                  <td>{{ $productforbuyer->id }}</td>
                                                  <th>Product Name</th>
                                                  <td>{{ $productforbuyer->product }}</td>
                                                </tr>
                                                <tr>
                                                  <th>Origin</th>
                                                  <td>{{ $productforbuyer->origin }}</td>
                                                  <th>Price</th>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>{{ $productforbuyer->physical_specification }}</td>
                                                  <th>Chemical Specification</th>
                                                  <td>{{ $productforbuyer->chemical_specification }}</td>
                                                </tr>
                                                <tr>
                                                  <th>Created By</th>
                                                  <td>{{ $productforbuyer->created_by }}</td>
                                                  <th>Created On</th>
                                                  <td>{{ $productforbuyer->created_at }}</td>
                                                </tr>
                                                <tr>
                                                  <th>Purchased By</th>
                                                  <td>{{ $productforbuyer->purchasedby }}</td>
                                                  <th>Purchased On</th>
                                                  <td>{{ $productforbuyer->purchasedon }}</td>
                                                </tr>
                                                <tr>
                                                  <th>Approve</th>
                                                  <td><i class="material-icons text-success">done_all</i></td>
                                                  <th>Disapprove</th>
                                                  <td><i class="material-icons text-danger">done_all</i></td>
                                                </tr>
                                              </table>
                                            </div>
                                          </div>
                    ...
                    <div class="tab-pane" id="link2">
                      <div class="card">
                        <div class="card-header card-header-primary">
                          <h4 class="card-title">Bid/Acceptance(Buyers)<span class="badge badge-light float-right">{{$productforsellersss}}</span></h4>
                          <p class="card-category">Bid/Acceptance for better accessbility.</p>
                        </div>
                        <div class="card-body">
                          <form method="POST" action="{{ url('/subuser-store') }}">
                            ...
                            <div class="row">
                              <table class="table table-sm">
                                ...
                                @foreach($productforsellers as $productforseller)
                                  <tr>
                                    <td>{{ \Illuminate\Support\Str::limit($productforseller->product, $limit = 10, $end = '...') }}</td>
                                    <td>{{ $productforseller->currency }}{{ $productforseller->price }}{{ $productforseller->perunit }}</td>
                                    <td>{{ $productforseller->quantity }}{{ $productforseller->unit }}</td>
                                    <td>{{ $productforseller->status }}</td>
                                    <td>
                                      <a type="button" rel="tooltip" title="Accept" class="btn btn-success btn-link btn-sm" href=""><i class="material-icons">visibility</i>
                                      </a>
                                    </td>
                                  </tr>
                                @endforeach
