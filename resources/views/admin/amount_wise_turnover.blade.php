             ...
             <div class="breadcrumbbar">
              <div class="row align-items-center">
                  <div class="col-md-8 col-lg-8">
                      <h4 class="page-title">Amount Wise Turnover</h4>
                      <div class="breadcrumb-list">
                          <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Dashboard</a></li>
                              <li class="breadcrumb-item"><a href="">Reports</a></li>
                              <li class="breadcrumb-item active" aria-current="page">Amount Wise Turnover</li>
                          </ol>
                      </div>
                  </div>
              </div>          
                 ...
                 <div class="table-responsive">
                  ...
                  <tr>
                    <?php
                      ...
                      $total_price = \App\Finalbid::sum('new_price');
                      $total_quantity = \App\Finalbid::sum('new_quantity');
                    ...
                    <td>{{number_format($total_quantity)}}{{$new_unit_without_slash}}</td>
                  </tr>
                  @endforeach
                </table>
              </div>
