...
<body class="">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Business Type Master</a>
          </div>
                ...
                <div class="card-header card-header-tabs card-header-primary">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                      <span class="nav-tabs-title">Edit Business Type</span>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                  <div class="tab-content">
                    <div class="tab-pane active" id="profile">
                      ...
                      @endif
                      <form method="POST" action="{{ url('update-businesstype') }}/{{$businesstype}}" id="">
                        @csrf
                        <div class="row">
                          <div class="col-sm-4">
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$businesstypeedit->name}}" required autocomplete="name" autofocus placeholder="Name">
                            @error('name')
                          ...
                          <div class="col-sm-2">
                              ...
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="checkbox" value="USD $" name="default_currency[]"
                                   <?php if (in_array('"USD $"', $currency_data)): ?>
                                    <?php echo 'Checked' ?>
                                          <?php else: ?>
                                            <?php echo '' ?>        
                                          <?php endif ?>   
                              ...
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="checkbox" value="INR ₹" name="default_currency[]"
                                   <?php if (in_array('"INR \u20b9"', $currency_data)): ?>
                                   <?php echo 'Checked' ?>
                                          <?php else: ?>
                                            <?php echo '' ?>        
                                          <?php endif ?>   
                          ...
                          <div class="col-sm-2">
                              ...
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="checkbox" value="Buyer" name="registered_as[]"
                                   <?php if (in_array('"Buyer"', $registered_data)): ?>
                                    <?php echo 'Checked' ?>
                                          <?php else: ?>
                                            <?php echo '' ?>        
                                          <?php endif ?>   
                              ...
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="checkbox" value="Seller" name="registered_as[]"
                                   <?php if (in_array('"Seller"', $registered_data)): ?>
                                   <?php echo 'Checked' ?>
                                          <?php else: ?>
                                            <?php echo '' ?>        
                                          <?php endif ?>   
                          ...
                          <div class="col-sm-2">
                              ...
                              <div class="form-check">
                                <label class="form-check-label">
                                  <input class="form-check-input" type="checkbox" value="Work" name="work_details[]" 
                                  <?php if (in_array('"Work"', $worked_data)): ?>
                                  <?php echo 'Checked' ?>
                                          <?php else: ?>
                                            <?php echo '' ?>        
                                          <?php endif ?>   
  ...
  $(document).ready(function(){
      ...
      $(".master-link").attr("aria-expanded","true");
  });
  </script>
  <script>
    $(document).ready(function() {
