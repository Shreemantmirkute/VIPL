        ...
        <div class="breadcrumbbar">
          <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-4">
              <div class="widgetbar">
                <button id="hide-btn" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>Add New Role</button>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-12 add_new_product" style="display: none;">
              ...
              <div class="card m-b-30">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url('create-role') }}" id="addrole">
                    @csrf
                    <div class="row">
                      <div class="col-sm-3">
                  ...
                  <div class="table-responsive">
                    <table id="default-datatable" class="table">
                      ...
                      <tr>
                        ...
                        <td>{{ $role->name }}</td>
                        <td>
                          <a type="button" rel="tooltip" title="Edit Product" class="btn btn-primary btn-round text-white" data-toggle="modal" data-target="#edit{{ $role->id }}"><i class="fa fa-edit"></i>
                          </a>
                          <!--Modal Start -->
                                    ...
                                    <div class="row">
                                      <div class="col-sm-6">
                                        <div class="form-group bmd-form-group">
                                          ...
                                          <input type="text" class="form-control" id="id" required="true" name="id" aria-required="true" value="{{ $role->id }}">
                                        </div>
                                      </div>
                                      <div class="col-sm-6">
                                        <div class="form-group bmd-form-group">
                                          <label for="name" class="bmd-label-floating"> Name *</label>
                                          <input type="text" class="form-control" id="name1" required="true" name="name" aria-required="true" value="{{ $role->name }}">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row">
                          ...
                          <!-- <button type="button" rel="tooltip" title="View Category" class="btn btn-primary btn-link btn-sm" data-toggle="modal" data-target="#viewCategory{{ $role->id }}">
                          ...
                          <!-- <a type="button" rel="tooltip" title="Activate" class="btn btn-success btn-link btn-sm" onclick="return confirm('Are you sure?')" href="{{ url('activate-category', [$role->id]) }}">
                            <i class="material-icons">verified_user</i>
                          </a>
                          <a type="button" rel="tooltip" title="Deactivate" class="btn btn-danger btn-link btn-sm" onclick="return confirm('Are you sure?')" href="{{ url('deactivate-category', [$role->id]) }}">
                            <i class="material-icons">warning</i>
                          </a> -->
                          <a type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-round" data-toggle="tooltip" data-placement="top" onclick="return confirm('Are you sure?')" href="{{ url('delete-currency', [$role->id]) }}">
