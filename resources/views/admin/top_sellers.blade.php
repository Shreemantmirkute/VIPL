            ...
            <div class="breadcrumbbar">
              <div class="row align-items-center">
                  <div class="col-md-8 col-lg-8">
                      <h4 class="page-title">Top Sellers</h4>
            ...
            <div class="contentbar"> 
              ...
              <div class="card-header">
                ...
                <div class="table-responsive">
                  ...
                  @foreach($finalbids->unique('seller_id') as $finalbid)
                  <tr>
                    <?php
                      $seller_name = \App\Profile::where('user_id', $finalbid->seller_id)->pluck('company_name')->first();
                      $total_price = \App\Finalbid::where('buyer_id', $finalbid->seller_id)->where('status', "Completed")->sum('new_price');
                      $total_quantity = \App\Finalbid::where('buyer_id', $finalbid->seller_id)->where('status', "Completed")->sum('new_quantity');
