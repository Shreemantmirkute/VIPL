        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats" style="cursor:pointer" onclick="document.location='{{ url('admin/users') }}'">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats" style="cursor:pointer" onclick="document.location='{{ url('admin/category') }}'">
                <div class="card-header card-header-success card-header-icon">
                  <div class="card-icon">
                    <i class="material-icons">store</i>
                  </div>
                  <p class="card-category">Category</p>
                  <h3 class="card-title">{{ \App\Category::all()->count() }}</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats" style="cursor:pointer" onclick="document.location='{{ url('admin/product') }}'">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h3 class="card-title">{{ \App\Item::all()->count() }}</h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="active">
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ asset('admin_theme_assets/img/sidebar-1.jpg') }}" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ asset('admin_theme_assets/img/sidebar-2.jpg') }}" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ asset('admin_theme_assets/img/sidebar-3.jpg') }}" alt="">
          </a>
        </li>
        <li>
          <a class="img-holder switch-trigger" href="javascript:void(0)">
            <img src="{{ asset('admin_theme_assets/img/sidebar-4.jpg') }}" alt="">
          </a>
        </li>
