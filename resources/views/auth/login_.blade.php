                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  ...
                                  Welcome To Vyapaarnetwork</h2>
                                  
                                </div>
                                <div class="modal-body">
                                  <h3>Thankyou for registring with vyapaarnetwork the future of bidding!<br><br>
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-primary" data-dismiss="modal">Login To Continue</button>
                                </div>
                              </div>
                            </div>
                          </div>
