            ...
            <div class="topbar">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-12 align-self-center">
                        ...
                        <div class="infobar">
                            <ul class="list-inline mb-0">
                                <li class="list-inline-item"><strong><span id="time"></span></strong></li>
...
<!--                                                         <span class="action-icon badge badge-primary-inverse"><i class="feather icon-bell"></i></span>
                                    ...
                                    <div class="profilebar">
                                        <div class="dropdown">
                                          <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <img src="{{ asset('/imageupload/profile/'.$img) }}" class="img-fluid" width="40px">
