...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="{{ asset('admin_theme_assets/img/sidebar-1.jpg') }}">
      <!--
            ...
            <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Vyapaarnetwork</h4>
                  <p class="card-category">Welcome to Vyapaarnetwork</p>
                </div>                
                <div class="card-body">
                  Thanks for registering with us.
                  <h3>Soon you will receive a mail from Vyapaarnetwork.</h3>
                  <a href="{{ url('/pending_user_dashboard') }}"><h4 class="btn btn-primary">Goto Your Dashboard</h4></a>
                </div>
              </div>
            </div>
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright float-right">
            ...
            <a href="https://www.webtactic.in" target="_blank">Webtactic</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      $("#exampleFormControlSelect11").change(function()
      {
        var prod = $(this).val();
