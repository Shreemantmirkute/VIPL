    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animated fadeInDown">My Help Files</span></h2>
    ...
    <section id="about" class="about">
      <div class="container">
        <div class="section-title" data-aos="zoom-out">
          ...
          <p>My help files</p>
          <code>
            php artisan make:mail SendPasswordChangeMail<br>
            composer require laravel/ui --dev<br>
            php artisan ui bootstrap --auth<br>
            npm install<br>
            npm run dev<br>
            php artisan make:model Modelname -c -m<br>
            php artisan migrate --path=/database/migrations/filename.php<br>
            php artisan make:migration add_paid_to_users_table --table=users<br>
