        ...
        <div class="row">
          ...
          <div class="col-sm-3">
            <div class="card m-1 border-0">
              ...
              <?php } ?>                            
              <div class="card-body">
                <h5 class="card-title"><a href="{{ url('complete-news', [$newz->id]) }}" >{{Illuminate\Support\Str::limit($newz->title , 20)}}</a></h5>
                <p class="card-text">{{Illuminate\Support\Str::limit($newz->description , 50)}}</p>                
