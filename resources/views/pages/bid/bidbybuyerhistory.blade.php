                    ...
                    <div class="col-md-8">
                         ...
                         table-stripped">
                           ...
                           <tr>
                            ...
                            $product_name = \App\Seller::where('id', $finalbid->offer_id)->pluck('product_name')->first();
                            ?>
                            <td>{{$product_name}}</td>
                            <td>{{$buyer_name}}</td>
                            <td>{{$seller_name}}</td>
                            ...
                            <td><a type="button" rel="tooltip" title="Place Your Bid" class="btn btn-primary btn-link btn-sm" href="{{ url('bidbybuyerhistorysingle', [$finalbid->offer_id, $finalbid->seller_id, $finalbid->buyer_id, $finalbid->id]) }}"><i class="material-icons">gavel</i> Complete Trail</a></td>
                           </tr>
                           @endforeach
                         </table>
                    </div>                    
