        ...
        <div class="breadcrumbbar">
          <div class="row align-items-center">
            <div class="col-md-8 col-lg-8">
              <h4 class="page-title">Bidding Trails (Seller)</h4>
                          ...
                          <div class="chat-message chat-message-left">
                            ...
                            @foreach($profiles as $profile)
                              @if($bidbyseller->bidtype == 'bid')
                                ...
                                <div class="avatar">
                                  <img class="img-circle rounded-circle" style="width:50px;height:50px" src="{{ asset('/imageupload/profile/'.$profile->company_logo) }}">
                                </div>
