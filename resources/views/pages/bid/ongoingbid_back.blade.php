            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card p-3">
                  <div class="material-datatables">
                      <table id="datatables11" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                      <th>Date</th>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card p-3">
                  <div class="material-datatables">
                      <table id="datatables12" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                      <th>Date</th>
                      <th>Offer Product</th>
                      <th>Seller</th>
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="card p-3">
                  <div class="material-datatables">
                      <table id="datatables13" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                    <thead>
                      <th>Date</th>
                      <th>Enquiry Product</th>
                      <th>Buyer</th>
...
<!--Code by Ajay:-->
          ...
          <div class="row" id="add_user">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Productwise Buyer-Seller Trial Count</h4>
                  <!-- <p class="card-category">Let's Start Selling to your Potential Buyers</p> -->
                </div>               
                <div class="card-body">
                  <div class="card p-3">
                  <div class="material-datatables">
                      <table id="buyer_seller_trial_count_table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                          <thead>
                            <th>Product Name</th>
                            <th>Buyer Name</th>
                            <th>Seller Name</th>
                          ...
                          @foreach($buyerSellerTrialCount as $buyer)
                          <tr>
                            <td>{{ $buyer->product_name}}</td>                     
                            <td>{{ $buyer->buyer_name}}</td>                     
                            <td>{{ $buyer->seller_name}}</td>
                            <td>{{ $buyer->trial_count}}</td>
                          </tr>
                          @endforeach
                      </table>
                </div>
