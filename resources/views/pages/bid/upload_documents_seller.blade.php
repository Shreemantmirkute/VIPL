                    ...
                    <div class="card m-b-30">
                      @foreach($finalbids as $finalbid)
                        <div class="card-body">
                          ...
                          @endif
                          <form method="POST" action="{{ url('upload-doc-seller') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <label>Date</label>
                                  <input type="date" name="sale_date" placeholder="Date" class="form-control">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label>Quantity</label>
                                  <input type="text" name="quantity" placeholder="Quantity" class="form-control" value="{{$finalbid->new_quantity}}{{$finalbid->new_unit}}">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label>Amount</label>
                                  <input type="text" name="amount" placeholder="Amount" class="form-control" value="{{$finalbid->new_currency}}{{$finalbid->new_price}}{{$finalbid->new_perunit}}">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label>Acknowledgement</label>
                                  <input type="file" name="acknowledgement" placeholder="Acknowledgement" class="form-control">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label>Delivery Date</label>
                                  <input type="date" name="delivery_date" placeholder="Deivery Date" class="form-control">
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                                  <label>LR Number</label>
                                  <input type="text" name="lr_no" class="form-control" placeholder="LR Number" aria-describedby="basic-addon5" />
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
