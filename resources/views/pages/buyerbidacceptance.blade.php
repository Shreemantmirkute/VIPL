      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Buyer</a>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Bid/Acceptance(Buyers)<span class="badge badge-light float-right">888</span></h4>
                  ...
                  @foreach($buyers as $buyer)
                    <div class="">
                      <table class="col-sm-12 table-bordered">
                        ...
                        <tr>
                          <td>
                            <button class="btn btn-warning">Counter Bid</button>
                          </td>
                        </tr>
                      </table>
