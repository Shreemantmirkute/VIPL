...
<body class="">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Below are your enquiries</p>
                </div>
                <div class="card-body">
                    ...
                    <div class="material-datatables">
                      ...
                      <tr class="">
                        ...
                        @if( $buyer->status  == 'Active')
                            <td class="text-success font-weight-bold">{{ $buyer->status }}</td>
                            @else
                            <td class="text-danger font-weight-bold">{{ $buyer->status }}</td>
                        @endif
                        <td class="td-actions text-left">
                          ...
                          <a type="button" rel="tooltip" title="View More" class="btn btn-link btn-sm btn-primary" href="{{ url('/enquirybid', [$buyer->id]) }}"><i class="material-icons">visibility</i></a>
                          <!-- Modal -->
                          ...
                          @if( $buyer->status == 'Active')
                          <button type="button" class="btn btn-dark btn-link btn-sm disabled" data-toggle="modal" data-target="#"><i class="material-icons">edit</i>
                          </button>
                          @else
                          <button type="button" rel="tooltip" title="Edit Enquiry" class="btn btn-primary btn-link btn-sm " data-toggle="modal" data-target="#editOffer{{ $buyer->id }}"><i class="material-icons">edit</i>
                          </button>
                          @endif
                          <!-- Modal -->
                          ...
                          @if( $buyer->status == 'Active')
                          <a type="button" class="btn btn-dark btn-link btn-sm disabled" onclick="return confirm('Are you sure?')" href="#"><i class="material-icons">close</i></a>
                          @else
                          <a type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm" onclick="return confirm('Are you sure?')" href="{{ url('/delete-buyer', [$buyer->id]) }}"><i class="material-icons">close</i></a>
                          @endif
                          <a type="button" rel="tooltip" title="Activate" class="btn btn-success btn-link btn-sm" onclick="return confirm('Are you sure?')" href="{{ url('activate-enquiry', [$buyer->id]) }}"><i class="material-icons">verified_user</i></a>
                          <a type="button" rel="tooltip" title="Deactivate" class="btn btn-danger btn-link btn-sm" onclick="return confirm('Are you sure?')" href="{{ url('deactivate-enquiry', [$buyer->id]) }}"><i class="material-icons">warning</i></a>
                        </td>
                      </tr>
                      @endforeach
                    </table>
  ...
  $(document).ready(function(){
      ...
      $(".enquiry-list").addClass("active");
      $(".enquiry-collapse").addClass("show");
      $(".enquiry-link").attr("aria-expanded","true");
  });
  </script>
</body>
