                ...
                <div class="card-body">
                  <div class="row">
                      ...
                      <div class="product-slider-box product-box-for">
                        <?php foreach (json_decode($buyer->product_image) as $picture) { 
                          ...
                          $picture="noimage.png";
                              ...
                              <div class="product-preview">
                                <img src="{{ asset('/imageupload/enquiry/'.$picture) }}" class="img-fluid" />
                              </div>
                            <?php } ?>
                          </div>
                        <div class="product-slider-box product-box-nav">
                          ...
                          $picture="noimage.png";
                              ...
                              <div class="product-preview">
                                <img src="{{ asset('/imageupload/enquiry/'.$picture) }}" class="img-fluid" style="width: 150px;" />
                              </div>
                            <?php } ?>
                        </div>  
                      <?php
                    ...
                    <div class="col-md-8">
                      ...
                      <?php
                          $b11 = \App\Finalbid::where('enquiry_id', $buyer->id)->where('status', 'Completed')->where('admin_confirmation', '!=', 'Rejected')->get()->sum('new_quantity');
                          $a1 = \App\Finalbid::where('enquiry_id', $buyer->id)->where('admin_confirmation', '!=', 'Rejected')->where('seller_id', $buyer->created_by)->where('buyer_id', Auth::user()->id)->get()->sum('new_quantity');
                      ...
                      @if($b11 == $buyer->quantity)
                          ...
                          <ul class="list-inline mb-0">
                              ...
                              <li class="list-inline-item">
                                  <h4 class="mb-0">{{$buyer->quantity-$b1}} {{$b2}}</h4>
          ...
          <div class="row">
              ...
              <div class="col-lg-5 col-xl-4">
                  <div class="chat-list">
                      ...
                      @foreach($sellersforbid->unique('seller_id') as $bfb)
                        <!-- <a title="View In Detail" href="{{ url('counterbidbybuyer', [$bfb->enquiry_id, $bfb->buyer_id, $bfb->seller_id]) }}" id="mybutton"> -->
                          <a title="View In Detail" class="mybutton" data-xyz="{{$bfb->seller_id}}" data-enquiry_id="{{$bfb->enquiry_id}}" data-seller_id="{{$bfb->seller_id}}" data-buyer_id="{{$bfb->buyer_id}}">
                          <li class="media">
                              <?php 
                                          $company_name = \App\Profile::where('user_id', $bfb->seller_id)->pluck('company_name')->first();
                                          $img = \App\Profile::where('user_id', $bfb->seller_id)->pluck('company_logo')->first(); 
                                          if($img==""){
                          $img="noimage.png";
                        }?>
                                    ...
                                    @endif
                                     ...
                                     <span class="timing">{{$bfb->created_at}}</span>
                                  </h5>
                                          <p>Seller</p>
                                      </div>
                               </li>
  ...
  <script>
    $(document).ready(function() {
      ...
      $( ".mybutton" ).click(function(){
        ...
        enquiry_id = $(this).attr("data-enquiry_id");
