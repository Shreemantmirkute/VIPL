      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="{{ url('forget-password') }}">
              ...
              <div class="card text-center">
                <div class="card-header card-header-rose">
                  <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{ url('forget-password') }}">Forget Password</a>
                    </li>
                  </ul>
                </div>
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ url('change_password') }}">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Enter OTP</label>
