            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Create a new offer to sell your product.</p>
                </div>
                <div class="card-body">
                ...
                @endif
                  ...
                  <form method="POST" action="{{ url('/offer-post') }}" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                      <div class="col-md-3">
                    ...
                    <div class="row">
                      ...
                      <!-- <div class="col-md-4">
                        <div class="form-group">
                          <label for="category" class="bmd-label-floating">Select State</label>
                          <select class="form-control" id="atri" name="origin" required="">
