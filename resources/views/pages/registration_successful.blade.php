  ...
  <div class="site-wrapper-inner">
    <div class="cover-container">
      <div class="masthead clearfix">
        <div class="inner">
          <h3 class="masthead-brand"> Vyapaarnetwork </h3>
      ...
      <div class="inner cover">
        <h1 class="cover-heading">Registration has been submitted successfully</h1>
        <!-- <h5 class="sub-header"> Magic Happens Here </h5> -->
        <br>
        <p class="lead cover-copy">
            It's the Bright One, it's the Right One.</p>
            <p class="lead"><button type="button" class="btn btn-lg btn-default btn-notify" data-toggle="modal" data-target="#subscribeModal">Login To Continue </button></p>
      </div>
      <div class="mastfoot">
        <div class="inner">
            <p>© Webtactic . Design Made By <a href="https://digitalvichar.com" target="_blank" title="Hardik Gondhiya">Webtactic</a>.</p>
        </div>
      </div>
  </div>
</div>
