        ...
        <div class="breadcrumbbar">
            <div class="row align-items-center">
                <div class="col-md-8 col-lg-8">
                    <h4 class="page-title">Top Buyers & Sellers Report</h4>
          ...
          <div class="row">
                    ...
                    <div class="col-lg-5 col-xl-3">
                        <div class="card m-b-30">
                            <div class="card-header">                                
                                <h5 class="card-title mb-0">Choose Report</h5>
                            </div>
                            <div class="card-body">
                                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    <!-- <a class="nav-link mb-2" id="v-pills-dashboard-tab" data-toggle="pill" href="#v-pills-dashboard" role="tab" aria-controls="v-pills-dashboard" aria-selected="false"><i class="feather icon-grid mr-2"></i>Dashboard</a> -->
                                    <a class="nav-link mb-2 active" id="v-pills-order-tab" data-toggle="pill" href="#v-pills-order" role="tab" aria-controls="v-pills-order" aria-selected="true"><i class="feather icon-package mr-2"></i>Buyer Wise</a>
                                    <a class="nav-link mb-2" id="v-pills-addresses-tab" data-toggle="pill" href="#v-pills-addresses" role="tab" aria-controls="v-pills-addresses" aria-selected="false"><i class="feather icon-map-pin mr-2"></i>Seller Wise</a>
                                   <!-- <a class="nav-link mb-2" id="v-pills-wishlist-tab" data-toggle="pill" href="#v-pills-wishlist" role="tab" aria-controls="v-pills-wishlist" aria-selected="false"><i class="feather icon-heart mr-2"></i>Product Wise</a>-->
                                    <!-- <a class="nav-link mb-2" id="v-pills-wallet-tab" data-toggle="pill" href="#v-pills-wallet" role="tab" aria-controls="v-pills-wallet" aria-selected="false"><i class="feather icon-credit-card mr-2"></i>Latest Deals</a> -->
                                   <!--  <a class="nav-link mb-2" id="v-pills-chat-tab" data-toggle="pill" href="#v-pills-chat" role="tab" aria-controls="v-pills-chat" aria-selected="false"><i class="feather icon-message-circle mr-2"></i>Top Sellers</a>
                                    <a class="nav-link mb-2" id="v-pills-notifications-tab" data-toggle="pill" href="#v-pills-notifications" role="tab" aria-controls="v-pills-notifications" aria-selected="false"><i class="feather icon-bell mr-2"></i>Top Buyers</a>
                                    <a class="nav-link mb-2" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="feather icon-user mr-2"></i>Top Products</a> -->
                    ...
                    <div class="col-lg-7 col-xl-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <!-- Dashboard End -->
                            <!-- My Orders Start -->
                            <div class="tab-pane fade active show" id="v-pills-order" role="tabpanel" aria-labelledby="v-pills-order-tab">
                                <div class="card m-b-30">
                                    <div class="card-header">                                
                                                        ...
                                                        <table id="datatable-buttons1" class="table table-borderless" style="width: 100%">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{$seller_name}}</td>
                                                                    <td>{{number_format($total_revenue_seller)}}</td>
                                                                    <td >{{number_format($total_qty_seller)}}</td>
                                                                    <td >{{number_format($total_revenue_seller * $total_qty_seller)}}</td>
                                                                </tr>
                                                                @endforeach
                                                            </tbody>
