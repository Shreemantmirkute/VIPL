            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Let's Start Buying from your Potential Sellers</p>
                </div>
                  ...
                  <tr>
                    ...
                    <td class="td-actions">
                     <!--  <button type="button" rel="tooltip" title="View Product" class="btn btn-primary btn-link btn-sm" data-toggle="modal" data-target="#viewItem{{ $item->id }}">
                      ...
                      <!-- <button type="button" rel="tooltip" title="Edit Product" class="btn btn-primary btn-link btn-sm" data-toggle="modal" data-target="#editItem{{ $item->id }}" disabled="disabled">
                      ...
                      <!-- <div class="modal fade" id="editItem{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="POST" action="{{ url('update-item') }}">
                                ...
                                <div class="row">                                  
                                  <div class="col-sm-3">
                                    <input type="text" class="form-control" name="id" required autocomplete="id" autofocus readonly="readonly" value="{{ $item->id }}">
                                  </div>
                                  <div class="col-sm-2">
                        ...
                        @if (\App\Buyer::where('product', '=', $item->product)->where('created_by', '=', Auth::user()->id)->exists() or \App\Seller::where('product', '=', $item->product)->where('created_by', '=', Auth::user()->id)->exists())         
                          <a type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm disabled" onclick="return confirm('Are you sure?')" href="{{ url('delete-item', [$item->id]) }}">
                            <i class="material-icons">close</i>
                          </a>
                          @else
                          <a type="button" rel="tooltip" title="Remove" class="btn btn-danger btn-link btn-sm" onclick="return confirm('Are you sure?')" href="{{ url('delete-item', [$item->id]) }}">
                            <i class="material-icons">close</i>
                          </a>                     
                        @endif -->
                        <a type="button" rel="tooltip" title="PLace Your Bid" class="btn btn-primary btn-link btn-sm" href="{{ url('bidbybuyer', [$item->id, $item->created_by, Auth::user()->id]) }}"><i class="material-icons">gavel</i> Place your bid
                              </a>
                    </td>
                  </tr>
                  @endif
