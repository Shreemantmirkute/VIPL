...
<body>
    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          ...
          <img id="hero" src="{{url('assets/image/clipboard-image1.png')}}">
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
          <!-- <p class="animated fadeInUp">Ut velit est quam dolor ad a aliquid qui aliquid. Sequi ea ut et est quaerat sequi nihil ut aliquam. Occaecati alias dolorem mollitia ut. Similique ea voluptatem. Esse doloremque accusamus repellendus deleniti vel. Minus et tempore modi architecto.</p> -->
          <img id="hero" src="{{url('assets/image/clipboard-image2.png')}}">
        </div>
      </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content" data-aos="fade-up">
          <div class="col-lg-6">
            <p>
             For almost Three Decades, our parent company has been a Industry Player in the field of Metals and Minerals. What started as a homegrown Family led Business, after it’s advanced nuances in diverse products, we now aim to provide a larger platform for Trading in the Metals and Minerals Industry. 
            </p>
            <!-- <ul>
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              The Idea is to translate 25 years of niche experience in trading to bind other establishments and connect diverse businesses of India to an online platform with an International & Overseas approach to businesses. 
            </p>
        ...
        <ul class="nav nav-tabs row d-flex">
          ...
          <li class="nav-item col-3" data-aos="zoom-in" data-aos-delay="300">
            <a class="nav-link" data-toggle="tab" href="#tab-4">
              ...
              <h4 class="d-none d-lg-block">What We will Provide</h4>
            </a>
          </li>
        </ul>
        ...
        <div class="tab-content" data-aos="fade-up">
          <div class="tab-pane active show" id="tab-1">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i>  Go to our sign up page, where you can register under a buyer/seller.</li>
                  <li><i class="ri-check-double-line"></i> Page will request you for Details that are essential for your profile Verification. Ensure to answer them to the highest accuracy! </li>
                  <li><i class="ri-check-double-line"></i>You can Register as a Manufacturer, Manufacturer & Importer, Trader, Trader & importer, Exporter and list down your products.</li>
                  <li><i class="ri-check-double-line"></i>Once Admin verifies your profile and products, you may enter the bidding stage where one connects with buyers and sellers, making Trading easy and fun! Not to forget, safe and transparent.</li>
                </ul>
                <!-- <p>
              ...
              <div class="col-lg-6 order-1 order-lg-2 text-center">
                <img src="home_theme_assets/img/clipboard-image.png" alt="" class="img-fluid">
              </div>
            </div>
          </div>
          <div class="tab-pane" id="tab-2">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i>Quality Commitment Delivery</li>
                  <li><i class="ri-check-double-line"></i>Genuine / Verified Profiles</li>
                  <li><i class="ri-check-double-line"></i>Direct interaction between Buy and Seller</li>
                  <li><i class="ri-check-double-line"></i>Reduce intermediaries</li>
                  <li><i class="ri-check-double-line"></i>Hassle free trade</li>
                  <li><i class="ri-check-double-line"></i>Multiple trading on a single platform</li>
                  <li><i class="ri-check-double-line"></i>100% transparency</li>
                  <li><i class="ri-check-double-line"></i>User friendly experience / easy to operate</li>
                  <li><i class="ri-check-double-line"></i>Bridging gaps between buyer and seller</li>
                  <li><i class="ri-check-double-line"></i>Cross border trading also possible on a click of a button</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                <h3>What We Do</h3>
                <p>Our Core business type being Trading, it is essential for us to find the true potential of our Buyers and Sellers for efficiency in Trade. We ensure effective deals shouldering to the strength of our wide network in the trading market. We aim to be India’s largest Trading Nexus.
                </p>
              <!--   <ul>
                  <li><i class="ri-check-double-line"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat.</li>
                  <li><i class="ri-check-double-line"></i> Duis aute irure dolor in reprehenderit in voluptate velit.</li>
                ...
                <p>
                  The entire process and product range are set to the stringent quality norms laid by various reputed agencies and International Regulations. All Buyers and Sellers must meet Vyapaar Network’s minimum performance standards.
                </p>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0">
                ...
                <ul>
                  <li><i class="ri-check-double-line"></i> Ease of Buying Raw Materials/Minerals</li>
                  <li><i class="ri-check-double-line"></i> Connecting Industry Types and Diverse Sectors</li>
                  <li><i class="ri-check-double-line"></i> Bridging Gaps in Manufacturing, Retail & Corporate India</li>
                  <li><i class="ri-check-double-line"></i> A foundation of Trust and Transparency in Trading</li>
                  <li><i class="ri-check-double-line"></i> Value for Money & Good Deals in a Niche Sector for Trading</li>
                  <li><i class="ri-check-double-line"></i> Quality Products with Stringent Quality Control and Checks</li>
                </ul>
              </div>
              <div class="col-lg-6 order-1 order-lg-2 text-center">
  ...
  <a href="https://api.whatsapp.com/send?phone=+917503603844&amp;text=Hey" id="left"><img src="admin_theme_assets/img/wp.png"></a>
